module github.com/goliatone/go-notifications/examples/web

go 1.24.0

replace github.com/goliatone/go-notifications => ../..
...
require (
	...
	github.com/uptrace/bun/dbfixture v1.2.14 // indirect
